...
namespace fnm {
    bool init(RzCore *core) {
        ...
        auto fnm_scan_all_cd = rz_cmd_desc_argv_new(core->rcmd, fnm_cd, "fnm/",
                                                    fnm_scan_all_handler, &fnm_scan_all_help);
        rz_warn_if_fail(fnm_scan_all_cd);
        auto fnm_scan_this_cd = rz_cmd_desc_argv_new(core->rcmd, fnm_cd, "fnm.",
                                                    fnm_scan_this_handler, &fnm_scan_this_help);
        rz_warn_if_fail(fnm_scan_this_cd);
